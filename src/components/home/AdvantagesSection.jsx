...
const AdvantagesSection = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-batik-navy/5 to-batik-brown/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Kepercayaan pelanggan adalah prioritas utama kami. Inilah yang membuat Batik Nusantara menjadi pilihan
            terbaik.
          </p>
        </div>
