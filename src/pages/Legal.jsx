  ...
  const policies = [
    {
      ...
      description: "Bagaimana kami mengumpulkan, menggunakan, dan melindungi informasi pribadi Anda",
    ...
    },
    {
      icon: Lock,
      title: "Keamanan Data",
      description: "Langkah-langkah yang kami ambil untuk melindungi data pelanggan",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {policies.map((policy, index) => (
              <div key={index} className="text-center group cursor-pointer">
                <div className="w-20 h-20 bg-batik-gold rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-batik-brown transition-colors duration-300">
                  <policy.icon className="text-white" size={32} />
                </div>
                <h3 className="font-serif text-xl font-semibold text-batik-brown mb-3">{policy.title}</h3>
                <p className="text-gray-600 mb-4 text-sm">{policy.description}</p>
                <p className="text-xs text-gray-500">Terakhir diperbarui: {policy.lastUpdated}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="flex items-center mb-6">
              ...
              <h2 className="font-serif text-3xl font-bold text-batik-brown">Kebijakan Privasi</h2>
            </div>

            <div className="space-y-6 text-gray-600">
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">1. Informasi yang Kami Kumpulkan</h3>
                <p className="mb-3">
              ...
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">2. Bagaimana Kami Menggunakan Informasi</h3>
                <p className="mb-3">Informasi yang dikumpulkan digunakan untuk:</p>
                <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">3. Perlindungan Data</h3>
                <p>
                  Kami menggunakan teknologi enkripsi SSL dan sistem keamanan berlapis untuk melindungi informasi
                  pribadi Anda. Data disimpan di server yang aman dan hanya dapat diakses oleh personel yang berwenang.
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-batik-brown mb-3">4. Berbagi Informasi</h3>
                <p>
                  Kami tidak menjual, menyewakan, atau membagikan informasi pribadi Anda kepada pihak ketiga tanpa
                  persetujuan, kecuali untuk keperluan pengiriman, pembayaran, atau kewajiban hukum.
                </p>
              </div>

              <div>
                <h3 className="font-semibold text-batik-brown mb-3">5. Hak Anda</h3>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
            <div className="flex items-center mb-6">
              ...
              <h2 className="font-serif text-3xl font-bold text-batik-brown">Syarat & Ketentuan</h2>
            </div>
            ...
            <div className="space-y-6 text-gray-600">
              ...
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">2. Pemesanan dan Pembayaran</h3>
                <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">3. Pengiriman</h3>
                <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">4. Garansi dan Pengembalian</h3>
                <ul className="list-disc list-inside space-y-1 ml-4">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="flex items-center mb-6">
              ...
              <h2 className="font-serif text-3xl font-bold text-batik-brown">Kebijakan Pengembalian</h2>
            </div>

            <div className="space-y-6 text-gray-600">
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">Ketentuan Pengembalian</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-green-800 mb-2">✓ Dapat Dikembalikan</h4>
                  ...
                  <div className="bg-red-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-red-800 mb-2">✗ Tidak Dapat Dikembalikan</h4>
              ...
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">Prosedur Pengembalian</h3>
              ...
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">Biaya Pengembalian</h3>
                <ul className="list-disc list-inside space-y-1 ml-4">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
            <div className="flex items-center mb-6">
              ...
              <h2 className="font-serif text-3xl font-bold text-batik-brown">Keamanan Data</h2>
            </div>

            <div className="space-y-6 text-gray-600">
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">Teknologi Keamanan</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-batik-cream/30 rounded-lg">
                    <Shield className="text-batik-gold mx-auto mb-2" size={24} />
                    <h4 className="font-semibold text-batik-brown">SSL Encryption</h4>
                    <p className="text-sm">256-bit SSL untuk semua transaksi</p>
                  </div>
                  <div className="text-center p-4 bg-batik-cream/30 rounded-lg">
                    <Lock className="text-batik-gold mx-auto mb-2" size={24} />
                    <h4 className="font-semibold text-batik-brown">Secure Server</h4>
                    <p className="text-sm">Server dengan firewall berlapis</p>
                  </div>
                  <div className="text-center p-4 bg-batik-cream/30 rounded-lg">
                    <Eye className="text-batik-gold mx-auto mb-2" size={24} />
                    <h4 className="font-semibold text-batik-brown">Monitoring 24/7</h4>
              ...
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">Komitmen Keamanan</h3>
                <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <div>
                <h3 className="font-semibold text-batik-brown mb-3">Pelaporan Insiden</h3>
                <p>
