  ...
  const process = [
    {
      ...
      description:
        "Pilih produk bundling atau special offer yang Anda inginkan",
    },
    {
      step: "02",
    ...
    },
    {
      ...
      description:
        "Lakukan pembayaran sesuai instruksi dan konfirmasi ke admin",
    },
    {
      step: "04",
            ...
            {offers.map((offer, index) => (
              <div
                ...
                className={`relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 ${
                  offer.popular ? "border-batik-gold" : "border-gray-100"
                } overflow-hidden`}
              >
                {offer.popular && (
                ...
                <div className="p-8">
                  ...
                  <h3 className="font-serif text-2xl font-bold text-batik-brown mb-4">
                    {offer.title}
                  </h3>
                  ...
                  <ul className="space-y-3 mb-6">
                    {offer.features.map((feature, idx) => (
                      <li key={idx} className="flex items-center">
                        <CheckCircle
                          className="text-batik-gold mr-3"
                          size={16}
                        />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Ikuti langkah mudah berikut untuk mendapatkan produk bundling &
              special offer dari kami.
            </p>
          </div>
