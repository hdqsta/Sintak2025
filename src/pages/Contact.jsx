      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="font-serif text-3xl font-bold text-batik-brown mb-6">
                Kirim Pesan
              </h2>
            ...
            <div>
              ...
              <div className="w-full h-64 bg-gradient-to-br from-batik-gold/20 to-batik-brown/20 rounded-lg mb-6 flex items-center justify-center">
                <div className="text-center text-batik-brown">
                  ...
                  <p className="text-sm">
                    Pasar Kitu Ilir Barat Permai, Palembang
                  </p>
                </div>
              </div>
              ...
              <div className="bg-batik-cream/30 rounded-lg p-6">
                <h3 className="font-serif text-xl font-semibold text-batik-brown mb-4">
                  Informasi Tambahan
                </h3>
