        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="w-full h-96 bg-gradient-to-br from-batik-gold/20 to-batik-brown/20 dark:from-batik-gold/10 dark:to-batik-brown/10 rounded-2xl">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-serif text-2xl font-bold text-batik-brown dark:text-batik-gold mb-4">
                Visi
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                Menjadi jembatan antara pengrajin lokal dan pasar global untuk
                melestarikan budaya melalui kerajinan tangan Indonesia.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Mempromosikan produk kerajinan asli Indonesia dengan platform
                digital yang mendukung kualitas, keaslian, dan kesejahteraan
                pengrajin.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Kami menjunjung tinggi keaslian, budaya, kualitas, pemberdayaan,
                dan inovasi dalam setiap langkah usaha kami.
              </p>
            </div>
          </div>
        </div>
